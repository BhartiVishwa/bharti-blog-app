    ...
    <div className="py-5 px-5 md:px-12 lg:px-20 ">
      <div className="flex justify-between items-center">
        <Image
          ...
          width={180}
          alt="logo"
          className="w-[130px] sm:w-auto bg-["
        />
        <Link href={'/admin'}>
        <button 
      ...
      <div className="text-center py-8">
        ...
        <form onSubmit={onsubmitHandler} className="flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border black shadow-[-7px_7px_0px_#000000]">
          ...
          <button
            type="submit"
            className="border-1 border-black py-4 px-4 dw- sm:px-8 active:bg-gray-600 active:text-wgite"
          >
            Susbcribe
          </button>
        </form>
